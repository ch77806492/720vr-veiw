...
.tour-marker.video.video-small{width:auto;height:auto;min-width:68px;min-height:30px;padding:6px 11px 6px 27px;overflow:visible;border:1px solid rgba(255,255,255,.42);border-radius:999px;background:#155ca8;color:#fff;font-size:11px;line-height:1.2;box-shadow:0 8px 20px rgba(11,63,138,.3);backdrop-filter:none}.tour-marker.video.video-small:after{display:none}.tour-marker.video.video-small:before{left:11px;top:50%;border-top-width:5px;border-bottom-width:5px;border-left-width:8px;border-left-color:#fff;transform:translateY(-50%);filter:none}.tour-marker.video .video-marker-label{position:relative;z-index:3}.tour-marker.video.video-large .video-marker-label{position:absolute;left:10px;right:10px;bottom:11px;overflow:hidden;color:#fff;font-size:12px;line-height:1.25;text-align:center;text-overflow:ellipsis;text-shadow:0 2px 6px rgba(0,0,0,.58);white-space:nowrap}.tour-marker.video.video-large:before{top:42%}
