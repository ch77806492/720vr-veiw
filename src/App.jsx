...
.tour-marker.video.video-small{width:auto;height:auto;min-width:68px;min-height:30px;padding:6px 11px 6px 27px;overflow:visible;border:1px solid rgba(255,255,255,.42);border-radius:999px;background:#155ca8;color:#fff;font-size:11px;line-height:1.2;box-shadow:0 8px 20px rgba(11,63,138,.3);backdrop-filter:none}.tour-marker.video.video-small:after{display:none}.tour-marker.video.video-small:before{left:11px;top:50%;border-top-width:5px;border-bottom-width:5px;border-left-width:8px;border-left-color:#fff;transform:translateY(-50%);filter:none}.tour-marker.video .video-marker-label{position:relative;z-index:3}.tour-marker.video.video-large .video-marker-label{position:absolute;left:10px;right:10px;bottom:9px;overflow:hidden;color:#e60012;font-size:24px;font-weight:400;line-height:1.2;text-align:center;text-overflow:ellipsis;text-shadow:0 1px 2px rgba(255,255,255,.72);white-space:nowrap}.tour-marker.video.video-large:before{top:38%}
